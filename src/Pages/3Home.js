...
import home_icon_top from "../Images/GamewinLogo1.png";
...
import imgBig from "../Images/GamewinLogo1.png"
import playBtn from "../Images/Component 1.png"
...
const Home = () => {
  ...
  useEffect(() => {
    // if(!localStorage.getItem("ani") || localStorage.getItem("ani")==="null" ||localStorage.getItem("ani")===undefined )
    // {
    //   navigate("/login");
    // }
    // else
  ...
  return (
    ...
    <>
      ...
      <div className="container white-bg">
        ...
        <div class="contineu_game_img">
          <div class="contineu_game_img_padding">
          <div class="contineu_text">
            Continue Playing And stand a chance to win yo share of prizes!
            <a href="#"> Play Now</a>
          </div>
          <div class="contineu_img">     
            <img alt="game-icon" src={imgBig} />
          </div>
          <div class="contineu_btn"><a href="#">More Games</a>       
            <img alt="" src={playBtn} /></div>
          </div>
        </div>
          {/* <span
