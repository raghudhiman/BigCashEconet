...
import coin from "../Images/R1.png";
      ...
      <div className="container white-bg">
        ...
        <div className="container-area">
          ...
          >
            {" "}
            {/* Winner Prizes */}
            Win Your Share Prizes
          </span>
          <p className="big-font">
            $100 is the Grand Cash Prize! <br />
          ...
          <div className="score-area-table">
            ...
            <div
              className="white-bg-shadow light-blue-bg padding-low"
            ...
            >
              ...
              <div className="rating-btn">
                {/* <div className="col-md-6 col-xs-6 faq">
                  <Link to="/faq">
